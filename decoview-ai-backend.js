...
app.get("/", (_req, res) => res.send("DecoView AI backend OK (v9) - IA + Tiendanube"));

const PORT = process.env.PORT || 8080;
app.listen(PORT, () => console.log(`DecoView AI backend v9 escuchando en el puerto ${PORT}`));
